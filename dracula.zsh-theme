...
#                   Dracula palette                  #
#----------------------------------------------------#
local BACKGROUND='236' #282a36 (Darker grey/Black)   #
local CURRENT_LINE='239' #44475a (Grey)              #
local SELECTION='239' #44475a (Grey)                 #
local FOREGROUND='253' #f8f8f2 (Whiteish)            #
local BLUE='61' #5f5faf (Comment)                    #
local CYAN='117' #8be9fd                             #
local GREEN='84' #50fa7b                             #
local ORANGE='215' #ffb86c                           #
local PINK='212' #ff79c6                             #
local PURPLE='141' #bd93f9                           #
local RED='203' #ff5555                              #
local YELLOW='228' #f1fa8c                           #
#----------------------------------------------------#
...
PROMPT+='%F{${PINK}}%B$(dracula_context)'
# }}}
